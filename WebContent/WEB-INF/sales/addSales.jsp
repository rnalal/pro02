...
<div class="content" style="padding-top:30px; margin-top:30px; border-top:3px solid #333; min-height:500px;">
	<div class="container-fluid">
		...
		<form action="${path1 }/AddPayment.do" method="post" onsubmit="return payCheck(this)">
			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td>
							구매 가능 수량 : <strong>${pro.pcount }</strong><br>
							<input type="number" name="pcount" id="pcount" value="${pcount }" min="0" max="${pro.pcount }" title="1~500" class="form-control" required>
						</td>
					</tr>
					<tr>
						<th>상품 이미지</th>
				...
				<tbody>
					<tr>
						...
						<td>
							...
							<button type="button" id="post_btn" onclick="findAddr()" class="btn btn-default" style="margin-bottom:36px;">우편번호 검색</button>
						</td>
					</tr>
					<tr>
						<th>받는 사람 연락처</th>
			...
			<div class="btn-group">
				<input type="submit" value="상품 구매 완료" class="btn btn-info">
